...
def generate_renders(category):
    ...
    if category == "shoes":
        generate_diffusion_renders(
            SHOE_SCENES_DIR,
            DATA_DIR / "diffusion_renders" / "shoes" / "11-one-stage-large",
            [diffusion_renderer],
            shoe_prompts,
            4,
        )
        generate_coco_datasets(
            DATA_DIR / "coco" / "shoes" / "diffusion_renders" / "11-one-stage-large",
            DATA_DIR / "diffusion_renders" / "shoes" / "11-one-stage-large",
            shoe_category,
        )
        ...
        generate_diffusion_renders(
            MUG_SCENES_DIR,
            DATA_DIR / "diffusion_renders" / "mugs" / "11-one-stage-large",
            [diffusion_renderer],
            mug_prompts,
            4,
        )
        generate_coco_datasets(
            DATA_DIR / "coco" / "mugs" / "diffusion_renders" / "11-one-stage-large",
            DATA_DIR / "diffusion_renders" / "mugs" / "11-one-stage-large",
            mug_category,
        )
        ...
        generate_diffusion_renders(
            TSHIRT_SCENES_DIR,
            DATA_DIR / "diffusion_renders" / "tshirts" / "11-one-stage-large",
            [diffusion_renderer],
            tshirt_prompts,
            4,
        )
        generate_coco_datasets(
            DATA_DIR / "coco" / "tshirts" / "diffusion_renders" / "11-one-stage-large",
            DATA_DIR / "diffusion_renders" / "tshirts" / "11-one-stage-large",
            tshirt_category,
        )
