...
def generate_renders(category):
    ...
    if category == "shoes":
        generate_diffusion_renders(
            SHOE_SCENES_DIR,
            DATA_DIR / "diffusion_renders" / "shoes" / "02-gemini-prompts",
            [diffusion_renderer],
            shoe_prompts,
            2,
        )
        generate_coco_datasets(
            DATA_DIR / "coco" / "shoes" / "diffusion_renders" / "02-gemini-prompts",
            DATA_DIR / "diffusion_renders" / "shoes" / "02-gemini-prompts",
            shoe_category,
        )
        ...
        generate_diffusion_renders(
            MUG_SCENES_DIR,
            DATA_DIR / "diffusion_renders" / "mugs" / "02-gemini-prompts",
            [diffusion_renderer],
            mug_prompts,
            2,
        )
        generate_coco_datasets(
            DATA_DIR / "coco" / "mugs" / "diffusion_renders" / "02-gemini-prompts",
            DATA_DIR / "diffusion_renders" / "mugs" / "02-gemini-prompts",
            mug_category,
        )
        ...
        generate_diffusion_renders(
            TSHIRT_SCENES_DIR,
            DATA_DIR / "diffusion_renders" / "tshirts" / "02-gemini-prompts",
            [diffusion_renderer],
            tshirt_prompts,
            2,
        )
        generate_coco_datasets(
            DATA_DIR / "coco" / "tshirts" / "diffusion_renders" / "02-gemini-prompts",
            DATA_DIR / "diffusion_renders" / "tshirts" / "02-gemini-prompts",
            tshirt_category,
        )
