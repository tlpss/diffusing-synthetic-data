...
def calculate_mae_for_dataset(
    ...
    for i in range(len(channel_config)):
        print(f"MAE for channel {channel_config[i]}: {average_errors[i]}")
    print(f"MAE: {sum(average_errors)/len(average_errors)}")
...
if __name__ == "__main__":
    ...
    avg_errors = calculate_mae_for_dataset(model, dataset_json_path, [["bottom"], ["handle"], ["top"]], False)
    print(avg_errors)
